...
export function CalculatorForm({
  ...
  const getFieldErrorMessages = (fieldKey: string): string[] => {
    ...
    if (fieldKey === "interestRate" && interestRateError)
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <FormattedNumberInput
            ...
            ariaDescribedBy={
              hasFieldError("principal")
                ? "principal-input-error"
                : "principal-input-help"
            }
        ...
        >
          <FormattedNumberInput
            ...
            ariaDescribedBy={
              hasFieldError("interestRate")
                ? "interest-rate-input-error"
                : "interest-rate-input-help"
            }
          ...
          <FormattedNumberInput
            ...
            ariaDescribedBy={
              hasFieldError("duration")
                ? "investment-term-input-error"
                : "investment-term-input-help"
            }
